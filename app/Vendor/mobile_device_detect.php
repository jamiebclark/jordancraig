...
function mobile_device_detect($iphone=true,$android=true,$opera=true,$blackberry=true,$palm=true,$windows=true,$mobileredirect=false,$desktopredirect=false){
  ...
  switch(true){ // using a switch against the following statements which could return true is more efficient than the previous method of using if statements
    ...
    case (stristr($user_agent, 'ipod')||stristr($user_agent, 'iphone')); // we find the words iphone or ipod in the user agent
    ...
    case (stristr($user_agent, 'android'));  // we find android in the user agent
    ...
    case (stristr($user_agent,'opera mini')); // we find opera mini in the user agent
    ...
    case (stristr($user_agent, 'blackberry')); // we find blackberry in the user agent
